...
\end{fullwidth}
    ...
    \subsection{Positive Incentives: Trading Fees} \label{subsec:tradingfees}
        ...
        \subsection{Rebates or Rewards?}
            ...
            We invited Colin Chan (\bhref{https://dydx.forum/u/0xcchan/summary}{@0xCchan}), a dYdX community member, to offer further insights on the differences between LP rewards and rebates:
    ...
    \subsection{Negative Incentives: Slashing, \& Jail} \label{subsec:mev}
        ...
        \subsubsection{Preventative Measures \& TEEs}

            MEV TEE SGX research by Xenophon Labs.
            
    % \subsection{To Do: Liquid Staking?}

    %     Give a brief overview of what liquid staking is and why dYdX might want to enable some kind of liquid staking?